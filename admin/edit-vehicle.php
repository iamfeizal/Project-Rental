...
<head>
	...
	<title>Projek Web Rental Mobil | Admin</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Gambaran Kendaraan<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label class="col-sm-2 control-label">Tipe Bahan Bakar<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-4">
Gambar 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Ganti Gambar 1</a>
</div>
<div class="col-sm-4">
Gambar 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Ganti Gambar 2</a>
</div>
<div class="col-sm-4">
Gambar 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Ganti Gambar 3</a>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Gambar 4<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Ganti Gambar 4</a>
</div>
<div class="col-sm-4">
Gambar 5
<?php if($result->Vimage5=="")
{
echo htmlentities("tidak tersedia");
} else {?>
<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage5);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Ganti Gambar 5</a>
<?php } ?>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Aksesoris</div>
<div class="panel-body">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2" >
													...
													<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Simpan Perubahan</button>
												</div>
											</div>
