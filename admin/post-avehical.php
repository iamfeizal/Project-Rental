			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Masukkan Kendaraan</h2>
...
<label class="col-sm-2 control-label">Pilih Tipe Bahan Bakar<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-4">
Gambar 1 <span style="color:red">*</span><input type="file" name="img1" required>
</div>
<div class="col-sm-4">
Gambar 2<span style="color:red">*</span><input type="file" name="img2" required>
</div>
<div class="col-sm-4">
Gambar 3<span style="color:red">*</span><input type="file" name="img3" required>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Gambar 4<span style="color:red">*</span><input type="file" name="img4" required>
</div>
<div class="col-sm-4">
Gambar 5<input type="file" name="img5">
</div>
